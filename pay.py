...
root=tk.Tk()
messageframe=tk.Frame(root,height=60,width=300,bg="green3")
messageframe.pack()

roboto_font = Font(family="Roboto", size=16)
label = tk.Label(messageframe, text="Payment Successful !", font=roboto_font,bg="green3")
label.place(x=35,y=15)


for_label1 = Image.open('right.png')
label1_height = 20
label1_width = 25
