...
root=tk.Tk()
messageframe=tk.Frame(root,height=60,width=200,bg="red")
messageframe.pack()

roboto_font = Font(family="Roboto", size=16)
label = tk.Label(messageframe, text="ERROR !", font=roboto_font,bg="red")
label.place(x=60,y=18)


for_label1 = Image.open('trob.png')
label1_height = 20
label1_width = 25
